...
def get_parser():
    ...
    parser.add_argument('--optim', default='sgd', type=str, help='optimizer',
                        choices=['sgd', 'adagrad', 'adam', 'amsgrad', 'adabound', 'amsbound','adamod','rmsprop', 'adasmooth'])
    ...
    parser.add_argument('--beta3', default=0.999, type=float, help='AdaSmooth coefficients beta_3')
...
def get_ckpt_name(model='resnet', optimizer='sgd', lr=0.1, final_lr=0.1, alpha=0.99, momentum=0.9,
    ...
    name = {
        ...
        'rmsprop': 'lr{}-alpha{}-momentum{}'.format(lr, alpha, momentum),
        'adasmooth': 'lr{}-betas{}-{}-{}-final_lr{}-gamma{}'.format(lr, beta1, beta2, beta3, final_lr, gamma)
...
def create_optimizer(args, model_params):
    if args.optim == 'sgd':
        ...
        return optim.RMSprop(model_params, args.lr, alpha=args.alpha, momentum=args.momentum)
    ...
    elif args.optim == 'adasmooth':
        return AdaSmooth(model_params, args.lr, betas=(args.beta1, args.beta2),
...
def main():
    ...
    ckpt_name = get_ckpt_name(model=args.model, optimizer=args.optim, lr=args.lr,
                              final_lr=args.final_lr, alpha=args.alpha, momentum=args.momentum,
